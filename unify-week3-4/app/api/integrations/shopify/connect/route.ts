...
// Step 1 of Shopify OAuth — redirects the user to Shopify's permission screen.
// The user must provide their shop domain first (e.g. "my-store.myshopify.com").
...
export async function GET(req: NextRequest) {
  ...
  await kv.set(`shopify:oauth:state:${state}`, orgId, { ex: 600 }); // 10 min TTL
